...
const BUILTIN_WORDLIST = [
    ...
    ["terbesar", "ter|be|sar"],
    ["kepulauan", "ke|pu|la|u|an"],

    // Kata berimbuhan (affixed words)
    ["mempelajari", "mem|pe|la|ja|ri"],
    ["kependidikan", "ke|pen|di|di|kan"],
    ...
    ["keindahan", "ke|in|da|han"],
    ["pengembangan", "pen|gem|ban|gan"],
    ["perkembangan", "per|kem|ban|gan"],
    ["pertumbuhan", "per|tum|bu|han"],
    ["kesehatan", "ke|se|ha|tan"],
    ["pemanfaatan", "pe|man|fa|a|tan"],
    ...
    ["kegiatan", "ke|gi|a|tan"],
    ["penilaian", "pe|ni|la|i|an"],
    ["pemahaman", "pe|ma|ha|man"],
    ["penggunaan", "peng|gu|na|an"],
    ["penyuluhan", "pen|yu|lu|han"],
    ["perlawanan", "per|la|wa|nan"],
    ["penangkaran", "pe|nang|ka|ran"],
    ["pembangunan", "pem|ban|gu|nan"],
    ["perhitungan", "per|hi|tun|gan"],
    ["penyelesaian", "pen|ye|le|sa|i|an"],
    ...
    // Multi-word
    ["Indonesia adalah negara", "In|do|ne|sia ada|lah ne|ga|ra"],
    ["Tipografi adalah", "Ti|po|gra|fi ada|lah"],
];
