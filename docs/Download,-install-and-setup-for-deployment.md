...
### Using GitHub
1. Go to [https://github.com/mlengse/Hyphenopoly/releases/latest](https://github.com/mlengse/Hyphenopoly/releases/latest) and download the latest stable version (don't be afraid of the name `Source code`).
...
3. Then follow the instructions on [https://github.com/mlengse/Hyphenopoly#usage-browser](https://github.com/mlengse/Hyphenopoly#usage-browser)
 
### Using npm.js
1. Run `npm i hyphenopoly` in your project folder
2. Tell Hyphenopoly where to find the files: [paths](./Config.md#paths-optional)
3. Follow the instructions on [https://github.com/mlengse/Hyphenopoly#usage-browser](https://github.com/mlengse/Hyphenopoly#usage-browser) (don't forget to adapt the paths)
