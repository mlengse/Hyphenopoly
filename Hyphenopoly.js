    ...
    ((H) => {
        ...
        function hyphenate(lang, sel, entity) {
            ...
            const regExpWord = (() => {
                ...
                /*
                 * Word-matching RegExp (auto-generated).
                 * Equivalent to the Unicode-aware pattern:
                 * /[...]{minwordlength,}/gui
                 *
                 * Matches sequences of Unicode letters, combining marks,
                 * and soft hyphens. The long character-class literal below
                 * covers \p{Letter} and \p{Mn} ranges for scripts not
                 * yet supported by ES2018 Unicode property escapes
                 * (legacy browsers).
                 */
                const reWord = RegExp(
