/**
 * @license MIT
 * Hyphenopoly6.1.0module.js 6.1.0 - hyphenation for node
...
function createTextHyphenator(lang) {
     ...
     *
     * Matches sequences of Unicode letters and hyphens. The long
     * character-class literal below covers \p{Letter} ranges for scripts
     * not yet supported by ES2018 Unicode property escapes (Node.js
     * environments).
     */
    const reWord = RegExp(
