...
### Removed
* BREAKING CHANGE: remove `Hyphenopoly.setup.classnames` – use [selectors](https://github.com/mlengse/Hyphenopoly/wiki/Global-Hyphenopoly-Object#new-with-version-260-selectors) instead
...
* Hyphenopoly exposes [Hyphenators](https://github.com/mlengse/Hyphenopoly/wiki/Hyphenators)
* fix issues with very long word (#33 and #34)
* hyphenopoly.module.js is now [easy to use with browserify](https://github.com/mlengse/Hyphenopoly/wiki/browserify)

## Version 2.4.0 (Sept 01, 2018)
* Implement fallback mechanism for language sub-tags where no patterns are available (e.g. en-au -> en-gb) [#29](https://github.com/mlengse/Hyphenopoly/issues/29)
* updated patterns for Thai [#25](https://github.com/hyphenation/tex-hyphen/pull/25)

## Version 2.3.0 (Juli 26, 2018)
* Don't use template strings [#28](https://github.com/mlengse/Hyphenopoly/issues/28)
...
* [6f9e539](https://github.com/mlengse/Hyphenopoly/commit/6f9e539a5dab2d1eff5bdeb0c7857c6fda9eb41e)
* bugfix: [#24](https://github.com/mlengse/Hyphenopoly/issues/24): [aeefe6e](https://github.com/mlengse/Hyphenopoly/commit/aeefe6e3a59e8356abc99ca490acabf6c3374d7b)
...
* Provide [node module](https://github.com/mlengse/Hyphenopoly/wiki/Node-Module)
* default file locations better reflect usual installations [#19](https://github.com/mlengse/Hyphenopoly/issues/19)
* Add ability to store results of feature tests (optional) [#22](https://github.com/mlengse/Hyphenopoly/issues/22)
...
* Better tooling: minify, eslint, testing (mocha), compiling [devDependencies](https://github.com/mlengse/Hyphenopoly/wiki/Usage-of-devDependencies)
